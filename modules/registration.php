  ...
  try {
   ...
   if ($stmt->rowCount() === 1) {
    ...
    try {
      ...
      $mail->SMTPAuth = true;                              
     $mail->Username = 'auditorne.php@gmail.com';//cactus.paradise11@gmail.com               
     $mail->Password = 'Sifra123';//cactusparadise123                   
     $mail->SMTPSecure = 'tls';                            
     $mail->Port = 587;                                
                    ...
                    $href = "http://localhost/sajtPHP/index.php?page=activate&active=" . $token;
